...
class MainTest{
	public static void main(String[] args) {
		Test5 test5 =new Test5("브랜드", "반팔", 10000);
		Test5 test6 =new Test5("브랜드", "반팔", 10000);
		Test5 test7 =new Test5("브랜드", "반팔", 10000);
		Test5 test8 =new Test5("브랜드", "반팔", 10000);
		Test5 test9 =new Test5("브랜드", "반팔", 10000);
		
		test5.showAsset();
		test5.showSales();
		test5.showSalesnumber();
		test5.showStack();
...
class Test5 {
	    ...
	    public Test5(String mk, String type, int sprice) {
