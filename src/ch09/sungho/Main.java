...
//        }
        ...
        //p142 06_1 : 정수 둘을 인자로 전달받아서 두 수의 사칙연산 결과를 출력하는 메소드와 이 매소드를 호출하는 main메소드를 정의해보자. 단 나눗셈은
        //몫과 나머지를 각각 출력해야한다.

//        simpleCal(12, 13);
//
//        public static void simpleCal(int num1, int num2) { //이 부분은 원래 메인메소드 밖에 있어야한다. 문제 순서를 위해 안에다 넣었다.
//            System.out.printf("[%d] + [%d] = [%d]\n " , num1 , num2, num1 + num2);
//            System.out.printf("[%d] - [%d] = [%d]\n " , num1 , num2, num1 - num2);
//            System.out.printf("[%d] * [%d] = [%d]\n " , num1 , num2, num1 * num2);
//            System.out.printf("[%d] / [%d] = [%d] , 나머지는 : [%d]]\n " , num1 , num2, num1 / num2, num1 % num2);
//        }


        //p142 06_2 : 정수 둘을 인자로 전달받아서, "두 수의 차의 절대값"을 계산하여 출력하는 메소드와 이 메소드를 호출하는 main 메소드를 정의해보자.
        //단 메소드 호출시 값의 순서에 상관없이 절대값이 계산되고 출력되어야 한다.



/* p216 쪽 09-1문제 서클 클래스 정의하고 메인메소드로 불러와서 사용해보기
...
class Circle2 {
    ...
    public void cirCleInfo(){
        System.out.printf("r은 = %d 입니다", radi);
    }
...
class point2 {
    ...
    public void showInfo(){
        System.out.printf("원의 x,y는 %d, %d 입니다.", x, y);
    }
}
...
/* p237 10_1 번 문제 클래스변수와 클래스 메소드
다음 main 메소드와 함께 동작하는 Accumulator 클래스를 정의하자. 그리고 Accumulator클래스에 main메소드도 넣어서 컴파일 및 실행을 하자.
